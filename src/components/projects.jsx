  ...
  const ProjectCard = ({ project, color }) => (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-gray-400 font-body">+ Video Demo</span>
      </div>
    </div>
  );
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {technicalProjects.map((project) => (
              <ProjectCard key={project.id} project={project} color="border-blue-200 hover:border-blue-500" />
            ))}
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {creativeProjects.map((project) => (
              <ProjectCard key={project.id} project={project} color="border-purple-200 hover:border-purple-500" />
            ))}
          </div>
        </div>
      </div>
